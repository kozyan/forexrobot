...
Param( $FileToCompile = "C:\Users\administrator\AppData\Roaming\MetaQuotes\Terminal\78D61077B4C86688517531BD9FD69587\MQL5\Experts\Test.mq5")
...
& "C:\Program Files\MetaTrader 5 - EXNESS\metaeditor64.exe" /compile:"$FileToCompile" /log:"$LogFile" /inc:"C:\Users\administrator\AppData\Roaming\MetaQuotes\Terminal\78D61077B4C86688517531BD9FD69587\MQL5" | Out-Null
...
if ( $WhichColor -eq "Green") { & "C:\Program Files\MetaTrader 5 - EXNESS\terminal64.exe" }